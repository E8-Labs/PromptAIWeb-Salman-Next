...
type PromptSearchItemProps = {
  prompt: any;
  itemSelected(input: any): void;
};

function PromptSearchItem({ prompt, itemSelected }: PromptSearchItemProps) {
  return (
    <div
      className="flex flex-col h-62  bg-appgreen rounded p-4 cursor:pointer"
      key={prompt.id}
