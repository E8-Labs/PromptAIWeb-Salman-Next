...
type StackPromptTextFormProps = {
  onNext(): void;
  formData: any;
  updateFormData(input: any): void;
};

export default function StackPromptTextForm({
  onNext,
  formData,
  updateFormData,
}: StackPromptTextFormProps) {
      ...
      <div className="flex-col mx-auto justify-center bg-transparent items-center w-11/12 ">
        <FormContainer className="">
          <form className="gap-sm-4 form flex flex-col  mx-auto justify-center items-center  w-11/12">
            <input
              className="flex bg-transparent custom-scrollbar"
              type="textarea"
            ...
            <div className="flex gap-3 my-5 " style={{ width: "100%" }}>
              <Image src={infoIcon} alt="" width={25} height={15} />
