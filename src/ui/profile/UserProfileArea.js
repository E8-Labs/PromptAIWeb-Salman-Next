                                            ...
                                            <div className="subscribe_btn">
                                                ...
                                                {/* {props.UserID != localStorage.getItem('mongodb_userid')?
                                                    (props.FollowStatus?
                                                        ...
                                                        :
                                                        <div to="#" onClick={followers_request.bind(this)} >Follow</div>
                                                    )
                                                    :
                                                    ''
                                                } */}
                                            ...
                                            <p style={{cursor:'pointer'}} onClick={ShowCommunity.bind(this)} >{props.FollowersLength} Followers</p>
                                                ...
                                                {/* <ul>
                                                    {props.SocialLinks.Instagram?
                                                        <li><div target="_blank" to={props.SocialLinks.Instagram}><img src="../assets/img/instagram.png" alt="" /></div></li>
                                                        :
                                                        ''
                                                    }
                                                    {props.SocialLinks.Youtube?
                                                        <li><div target="_blank" to={props.SocialLinks.Youtube}><img src="../assets/img/youtube.png" alt="" /></div></li>
                                                        :
                                                        ''
                                                    }
                                                    {props.SocialLinks.Website?
                                                        <li><div target="_blank" to={props.SocialLinks.Website}><img src="../assets/img/globe.png" alt="" /></div></li>
                                                        :
                                                        ''
                                                    }
                                                </ul> */}
